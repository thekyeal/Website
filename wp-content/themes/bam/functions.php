...
final class Bam_Theme {
	...
	public function theme_setup() {
		...
		*/
		...
		add_image_size('pageBanner',1350, 300, true);
...
function pageBanner($args=null)
{
        ...
        if(!$args['photo'])
        {
            ...
            {
                $args['photo'] = get_theme_file_uri('/images/test.jpg');
            }
        }
...
?> 
       ...
       <img src="<?php echo $args['photo']; ?>" alt="Banner Image">
      <h4 style="color:#ff4f4f"> <?php echo $args['subtitle']; ?></h4>                 
...
function new_custom_login_logo() {
	    echo '<style>
	        h1 a { background-image:url('.get_stylesheet_directory_uri().'/chupp.png)!important; !important; background-size: auto auto !important; }
	    </style>';
}
...
function new_custom_login_page_style() {
	    echo '<style>
			...
			#loginform  { background-color: #ff4f4f; }
			#registerform  { background-color: #ff4f4f; }
