	...
	<div id="primary" class="content-area">
		...
		<main id="main" class="site-main">
			...
			while ( have_posts() ) :
				...
				get_template_part( 'partials/single/content' );
				          ...
				          $relatedBrand = get_field('related_bran');
				            if($relatedBrand )
				            {				    
				                echo '<h2 style="text-decoration: underline overline">Featured Brand(s)</h2>';
				                ?>
			...
			?>				<span class="cat-links">
				                	<li><a rel="category tag" href="<?php echo get_the_permalink($brand);?>"> <h4><?php echo get_the_title($brand);?> </h4></a></span>
				                	<?php
				      		}
